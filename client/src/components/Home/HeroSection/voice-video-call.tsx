...
export const VideoVoiceCall = () => {
  return (
    <div className="h-fit w-full lg:w-[70%] px-5 py-18 gap-10 flex flex-col md:flex-row md:gap-0">
        ...
        <div className="h-fit w-full md:w-1/2 flex justify-center md:justify-end items-center">
