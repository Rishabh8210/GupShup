...
export const HeroMain = () => {
    return (
        <>
            ...
            <p className="text-right text-[13px] text-zinc-700 py-1 px-3">*Data charges apply. Contact your provider for details.</p>
            <div className="h-fit w-full p-5 gap-12 flex flex-col justify-center items-center">
                <div className="h-44 w-full sm:h-48 md:h-52 flex justify-center items-center sm:w-[80%]">
