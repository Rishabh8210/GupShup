import { ArchiveX, Settings, Snail } from "lucide-react"
...
export const ChatSideNav = () => {
    return (
        <div className="h-full w-16 bg-[#000428] flex flex-col justify-between p-2 border-r border-zinc-500">
            <div className="h-fit w-full flex flex-col items-center pt-2 gap-1.5">
                <span className="h-fit p-2 bg-blue-300/15 cursor-pointer rounded-full w-fit flex justify-center items-center relative">
                ...
                <span className="h-fit p-2 hover:bg-blue-300/15 cursor-pointer rounded-full w-fit flex justify-center items-center relative">
                ...
                <span className="h-fit p-2 hover:bg-blue-300/15 cursor-pointer rounded-full w-fit flex justify-center items-center">
            ...
            <div className="h-fit w-full flex flex-col items-center gap-1.5 py-3">
                ...
                <span className="h-10 w-10 hover:bg-blue-300/15 cursor-pointer rounded-full flex justify-center items-center">
